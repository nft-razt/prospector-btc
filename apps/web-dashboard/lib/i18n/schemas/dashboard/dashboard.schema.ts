...
export const DashboardSchema = z.object({
  sidebar: z.object({
    ...
    analytics_deep: z
      .string()
      .describe("Título de la sección de análisis estratégico"),
    wallet_lab: z
      .string()
      .describe("Título de la sección de laboratorio forense"),
    academy: z.string().describe("Título de la sección de formación académica"),
    settings: z
      .string()
      .describe("Título de la sección de configuración de sistema"),
  }),
  header: z.object({
  ...
  fleet: z.object({
    ...
    deploy_hint: z
      .string()
      .describe("Instrucciones para inicializar el enjambre"),
    connection_lost: z
      .string()
      .describe("Mensaje de pérdida de enlace táctico"),
  }),
  lab: z.object({
    title: z.string().describe("Título del estrato experimental"),
    interceptor_title: z
      .string()
      .describe("Título del motor Interceptor neural"),
    ...
    no_scenarios: z
      .string()
      .describe("Mensaje cuando no hay experimentos activos"),
  }),
  vault: z.object({
  ...
  analytics_page: z.object({
    ...
    effort_distribution: z
      .string()
      .describe("Título de la gráfica de esfuerzo"),
    hardware_efficiency: z
      .string()
      .describe("Título de la gráfica de eficiencia"),
    geographical_nodes: z
      .string()
      .describe("Título del mapa de geolocalización"),
    ...
    metrics: z.object({
      ...
      collision_prob: z
        .string()
        .describe("Cálculo de probabilidad de colisión"),
    }),
  }),
  analytics: z.object({
    total_effort: z
      .string()
      .describe("Etiqueta de esfuerzo computacional global"),
    ...
    zombie_rate: z
      .string()
      .describe("Tasa de descubrimiento de carteras zombie"),
  }),
});
