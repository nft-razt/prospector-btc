...
export function IdentityInjector() {
  ...
  const mutation = useMutation({
    ...
    onMutate: () =>
      logger.info("Iniciando secuencia de inyección de identidad..."),
    onSuccess: () => {
      ...
      <CardContent className="relative z-10 flex-1">
        ...
        {showGuide && (
          <div className="mb-6 bg-slate-900/50 border border-slate-700/50 rounded-lg p-4 text-xs text-slate-300 space-y-2 animate-in fade-in slide-in-from-top-2">
            <h4 className="font-bold text-white mb-2 font-mono uppercase tracking-wider">
              Protocol: Cookie Extraction
            </h4>
            <ol className="list-decimal list-inside space-y-1 ml-1 marker:text-emerald-500">
              <li>
                Install <strong>Cookie-Editor</strong> extension.
              </li>
              <li>
                Login to <span className="text-emerald-400">Google Colab</span>.
              </li>
              <li>
                Open extension → Click <strong>Export</strong> (JSON).
              </li>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-widest text-slate-500 font-bold font-mono">
                Platform Target
              </label>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                />
                {errors.email && (
                  <span className="absolute right-3 top-3 text-[10px] text-destructive font-bold">
